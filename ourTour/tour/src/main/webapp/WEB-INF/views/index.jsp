				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header2">
									<a href="index.html" class="a2" ><strong>our T our</strong></a>
									<ul class="icons">
							...
							<section id="banner">
								...
								<div class="content2">
									...
									<ul class="actions">
										<li><a href="#" class="button big">커뮤니티 이동하기</a></li>
									</ul>
								</div>
							</section>
					...
					<div id="sidebar">
						<div class="inner">
							...
							<!-- Menu -->
								<nav id="menu">
									<header class="major2">
										<h2><a href="/html/login.html">로그인</a></h2>
									</header>
									<header class="major">
										<h2>메뉴</h2>
									</header>
									<ul>
										...
										<li><a href="elements.html">NULL2</a></li>
										<li><a href="elements.html">NULL3</a></li>
										</li>
									</ul>
								</nav>
